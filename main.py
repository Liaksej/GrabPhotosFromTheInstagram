...
class GDrive(InstaDownloader):

    def gdriver(self):
        """Shows basic usage of the Drive v3 API.
        Prints the names and ids of the first 10 files the user has access to.
        """
        global file_metadata_folder
        creds = None
        ...
        for count, name in enumerate(self.download_photo()):
            try:
                ...
                if name['media_type'] == 'VIDEO':
                    ...
                    media = MediaIoBaseUpload(ttt1, mimetype='video/mp4')
                    ...
                    media = MediaIoBaseUpload(ttt, mimetype='image/jpg')
                    file = service.files().create(body=file_metadata, media_body=media,
